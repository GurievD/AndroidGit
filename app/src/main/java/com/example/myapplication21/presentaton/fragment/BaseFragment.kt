...
abstract class BaseFragment: Fragment(), View.OnClickListener {
    ...
    fun getRoomTransactions() {
        ...
        Log.d("Получить весь список студентов", myRoomDatabase.getStudentDAO().initiateGetAllStudents().joinToString { it.toString() })
        Log.d("Получить весь список классов", myRoomDatabase.getSubjectDAO().initiateGetAllSubjects().joinToString { it.toString() })
        ...
        Log.d("Удалить определенный класс по ID", myRoomDatabase.getSubjectDAO().initiateGetSubjectById(2).toString())
